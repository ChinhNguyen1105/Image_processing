...
export default function HomePage() {
  ...
  // Thay thế đoạn khai báo useState của history cũ bằng đoạn này:
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      const historyItem = {
        id: Date.now(),
        name: fruitMapping[resData.fruit] || resData.fruit,
        isGreen: resData.green_confidence > resData.ripe_confidence,
        confidence: Math.max(resData.green_confidence, resData.ripe_confidence),
        green_confidence: resData.green_confidence,
        ripe_confidence: resData.ripe_confidence,
